    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <textarea
          ...
          className="mt-3 w-full bg-transparent border border-white/15 px-4 py-3 text-ivory placeholder:text-silver-dim/60 text-sm focus:border-gold outline-none transition-colors duration-300 resize-none"
        />
      </div>
  ...
  return (
    <div>
      ...
      <input
        ...
        className="mt-3 w-full bg-transparent border border-white/15 px-4 py-3 text-ivory placeholder:text-silver-dim/60 text-sm focus:border-gold outline-none transition-colors duration-300"
      />
    </div>
  );
}
