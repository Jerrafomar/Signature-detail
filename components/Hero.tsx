  ...
  return (
    <section className="relative h-[100svh] min-h-[640px] w-full overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1614200187524-dc4b892acf16?q=80&w=2400&auto=format&fit=crop')",
        }}
      />
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        <motion.h1
          ...
          className="font-display font-light text-6xl sm:text-7xl md:text-8xl lg:text-[9rem] leading-[0.95] text-ivory mt-6"
        >
        ...
        <motion.p
          ...
          className="mt-6 max-w-xl text-silver text-base sm:text-lg font-light tracking-wide"
        >
          Luxury Detailing for Exotic Cars &amp; Private Aircraft
        </motion.p>
