        ...
        <div className="mx-auto max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-14 items-start">
          ...
          <AnimatedSection direction="left" delay={0.1} className="space-y-6">
            <p className="body-copy">
              Signature Detail is a premium detailing company based in
              Montreal, specializing in luxury automotive detailing and
              private aircraft cabin detailing.
            </p>
            <p className="body-copy">
              Our mission is to deliver first-class detailing services with
              exceptional attention to detail, professionalism, and customer
              satisfaction — for owners who expect nothing less than
              excellence from everything they touch.
            </p>
            <p className="body-copy">
              Whether it is a hand-built supercar or the cabin of a private
              jet, every engagement follows the same disciplined process and
              is finished to the same exacting standard.
            </p>
          </AnimatedSection>
        </div>
      </section>
