...
export const metadata: Metadata = {
  ...
  description:
    "Request a quote from Signature Detail — premium mobile auto detailing serving Montreal, QC.",
};
...
const details = [
  ...
  { icon: MapPin, label: "Service Area", value: "Montreal, QC", href: undefined },
  { icon: Instagram, label: "Instagram", value: "@signaturedetail", href: "https://instagram.com" },
];
